...
public partial class Admin_ManagePoliceStation : System.Web.UI.Page
{
    ...
    protected void GVAddPoliNew_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        {
            con.Open();
            MySqlCommand cmd = new MySqlCommand("UPDATE crimereportingdb.tblpolice SET PoliceCode='" + PoliceCode + "', PoliceContactNo='" + PoliceContactNo + "', PoliceEmail='" + PoliceEmail + "', PoliceAddress='" + PoliceAddress + "', PoliceCity='" + PoliceCity + "', PolicePassword='" + PolicePassword + "' WHERE ID='" + ID + "' ", con);
    ...
    protected void GVAddPoliNew_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        ...
        using (MySqlConnection con = new MySqlConnection(cs))
        {
            ...
            MySqlCommand cmd = new MySqlCommand("DELETE FROM crimereportingdb.tblpolice WHERE ID='" + ID + "' ", con);
