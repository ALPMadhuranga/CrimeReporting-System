<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ComplainViewImage.aspx.cs" Inherits="Admin_ComplainView" %>
                                    ...
                                    <asp:GridView ID="GVCesas" runat="server" AutoGenerateColumns="False" DataKeyNames="ID" BackColor="White" BorderColor="#999999" BorderStyle="Solid" BorderWidth="1px" CellPadding="3" ForeColor="Black" GridLines="Vertical"  Width="100%" OnRowEditing="GVCesas_RowEditing" >
                                                ...
                                                <Columns>
                                                   <asp:BoundField DataField="ID" HeaderText="ID" />
                                                    ...
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Image ID="imgDocPic" runat="server"  ImageUrl='<%# Eval("ComplainVideo1") %>' Width="200px" BorderColor="Black" BorderWidth="1px" BorderStyle="Groove" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField>
                                                        <ItemTemplate>
                                                            <asp:Image ID="imgDocPic" runat="server"  ImageUrl='<%# Eval("ComplainVideo2") %>' Width="200px" BorderColor="Black" BorderWidth="1px" BorderStyle="Groove" />
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
