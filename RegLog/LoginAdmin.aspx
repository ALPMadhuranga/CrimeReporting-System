<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginAdmin.aspx.cs" Inherits="RegLog_LoginUser" %>
    ...
    <h2>Login Here</h2>
        <form runat="server">
            <table>
                ...
                <tr>
                    <td>
                        <asp:Label ID="lblusname" runat="server" Text="Admin NIC" Font-Bold="True" ForeColor="White"></asp:Label></td>
                    <td>
