<%@ Page Language="C#" AutoEventWireup="true" CodeFile="LoginPolice.aspx.cs" Inherits="RegLog_LoginUser" %>
        ...
        <form runat="server">
            <table>
                <tr>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtCode" ErrorMessage="* Police Code is Emptry" ForeColor="Red"></asp:RequiredFieldValidator>
                    </td></tr>
                <tr>
                    <td>
                        <asp:Label ID="lblusname" runat="server" Text="Police Code" Font-Bold="True" ForeColor="White"></asp:Label></td>
                    <td>
                        <asp:TextBox ID="txtCode" runat="server" CssClass="form-control" placeholder="" AutoCompleteType="Disabled"></asp:TextBox>
                    </td>
                </tr><tr><td></td><td>
