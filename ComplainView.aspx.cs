...
public partial class Admin_ComplainView : System.Web.UI.Page
{
    ...
    void PoliceStation()
    {
        ...
        cmd.CommandText = "SELECT DISTINCT ComplainPoliceStation FROM crimereporting.tblcomplain";
    ...
    {
        string query = "SELECT * FROM crimereporting.tblcomplain";
